...
public class SensorDataConverter {
  ...
  public static double scaleAccelerometerWithPrecision(final int port,
      final double raw, final double min, final double max) {
	  double result = 2 * ((raw - min) / (max - min)) - 1;
    return result;
  }
   ...
   */
  public static double scaleEDA(final int port, final double raw) {
   ...
   */
  public static double scaleLuminosity(final int port, final double raw) {
