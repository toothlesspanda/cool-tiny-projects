...
@WebServlet("/Internal/escolherGestor2")
public class EscolherGestorEvent2 extends Event {
	...
	public void process() throws ServletException, IOException, ApplicationException{
		...
		request.getRequestDispatcher("../escolherGestor2.jsp").forward(request, response);
