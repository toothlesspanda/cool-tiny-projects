...
@WebServlet("/Internal/emprestimo")
public class EmprestimoEvent extends Event {
	...
	public void process() throws ServletException, IOException, ApplicationException{
		...
		try{
			...
			if(id == null || id.equals("")){
				...
				ncph.setContasPrazo(app.getContasHandler().getContasPrazoDoBanco(nbh.getID()));
		...
		System.out.println("aqui Emp");
		request.getRequestDispatcher("../criaContaEmprestimo.jsp").forward(request, response);
