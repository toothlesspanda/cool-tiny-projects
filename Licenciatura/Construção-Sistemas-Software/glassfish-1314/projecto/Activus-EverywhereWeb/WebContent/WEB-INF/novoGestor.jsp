...
<body>
<h1 align="center">Activus:Adicionar Gestor</h1>
...
<hr>
	...
	<tr>		
		...
		<td><input class="mandatory_field" type="text" name="nome" size="50" value="${helper2.nome}" required="required"/></td>
		<td></td>
	</tr>
	<tr>		
		<td><label for="telefone"> Telefone:</label></td>
		<td><input class="mandatory_field" type="text" name="telefone" size="50" value="${helper2.telefone}" required="required"/></td>
		<td></td>
	</tr>
	<tr>		
		<td><label for="email"> Email:</label></td>
		<td><input class="mandatory_field" type="text" name="email" size="50" value="${helper2.email}" required="required"/></td>
		<td></td>
	</tr>
