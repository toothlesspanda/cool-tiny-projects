...
<form action="criarBanco" method="post">
	...
	<tr>		
		...
		<td><input class="mandatory_field" type="text" name="designacao" size="50" value="${helper.designacao}" required="required"/></td>
		<td></td>
	</tr>
	<tr>
		<td><label for="sigla"> Sigla:</label></td>
		<td><input class="mandatory_field" type="text" name="sigla" size="50" value="${helper.sigla}" required="required"/></td>	
		<td></td>
	</tr>
	<tr>
	<td></td>
