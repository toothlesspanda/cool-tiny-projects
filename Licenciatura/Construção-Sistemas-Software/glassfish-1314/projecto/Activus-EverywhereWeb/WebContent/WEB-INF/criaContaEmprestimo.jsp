...
<title>Activus:Adicionar conta emprestimo</title>
</head>
<body>
<h1 align="center">Activus</h1>
<h2 align="center">Adicionar conta emprestimo</h2>
<table align="center">
...
<hr>
	...
	<label for="conta">Contas a Prazo</label>
		<select name="contasID" multiple="multiple">
				<c:forEach var="conta" items="${helper3.contasPrazo}">
					<c:choose>
						<c:when test="${helper3.ID == conta.ID}">
							<option selected ="selected"  value="${conta.ID}">${conta.ID}</option>
						</c:when>
						<c:otherwise>
	...
	<tr>		
		...
		<td><input class="mandatory_field" type="text" name="deposito" size="50" value="${helper3.deposito}" required="required"/></td>
		<td></td>
	</tr>
	<tr>
		<td><label for="taxaJuro"> Taxa de Juro:</label></td>
		<td><input class="mandatory_field" type="text" name="taxaJuro" size="50" value="${helper3.taxaJuro}" required="required"/></td>	
		<td></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input class="mandatory_field" type="text" name="ano" size="50" value="${helper3.ano}" required="required"/></td>	
		<td></td>
	</tr>
	<tr>
		<td><label for="mes"> Mes:</label></td>
		<td><input class="mandatory_field" type="text" name="mes" size="50" value="${helper3.mes}" required="required"/></td>	
		<td></td>
	</tr>
	<tr>
		<td><label for="dia"> Dia:</label></td>
		<td><input class="mandatory_field" type="text" name="dia" size="50" value="${helper3.dia}" required="required"/></td>	
		<td></td>
	</tr>
	...
	<div class="button" align="center">
			<input type="submit" size="50" value="Adicionar Conta Emprestimo" />	
		</div>
